   ...
   const {updata, setUPdata} = useContext(updatedata)
    ...
    return (
        <div className="container shadow-lg p-3 mb-5 bg-body rounded-3 mt-4 ">
            ...
            <h3 className='text-center'>Edit the Details</h3>
            <form className="mt-4">
                <div className="row">
                    ...
                    <div className="mb-3 col-lg-6 col-md-6 col-12">
                        ...
                        <input type="date" value={inpval.dob} onChange={setdata} name="age" className="form-control" id="exampleInputPassword1" />
                    </div>
